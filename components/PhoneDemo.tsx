    ...
    <div>
      <Dialog>
        ...
        <DialogContent className="bg-slate-950 w-[98%] px-0  rounded-sm h-[90%] overflow-y-scroll ">
          ...
          <div className="w-full  md:scale-90 -translate-y-14 md:-translate-y-24 ">
            <div className="flex flex-col items-center">
              <section className="bg-neutral-100 p-3 rounded-lg mt-2 border-2 border-blue-700">
                <div className="bg-blue-700 rounded-sm p-4  z-10">
                  <h1 className="lg:text-5xl text-white text-3xl font-semibold p-3 rounded-lg">
                    Group Name
                  </h1>
                </div>
              </section>
              <section className="bg-neutral-100 p-2 rounded-lg mt-2 border-2 border-blue-700">
                <div className="flex text-white flex-row gap-2 py-3 text-2xl font-semibold pt-5 bg-blue-700 rounded-sm p-2  z-10">
                  <p>Total Messages:</p>
                  <p>34,790</p>
                </div>
              </section>
              <div className="pt-3 pb-3 justify-center flex w-[90%] text-center">
                <p className="text-sm font-semibold text-white">{`Reacted to the most messages: Jon Snow (8,888 reactions)`}</p>
              </div>
            </div>

            <Tabs defaultValue="total" className="w-full ">
              <TabsList className="w-full md:w-full justify-evenly ">
                <TabsTrigger
                  value="total"
                  className={`md:w-1/3 w-1/3 text-xs font-semibold font-Switzer text-blue-700`}
                >
                  Messages Sent
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="total">
                ...
                >
                  <div className="bg-neutral-100 p-3 rounded-lg flex order-1 h-fit w-full self-center lg:self-start border-2 border-blue-700">
                    <div
                      ref={div1Ref}
                      className="pt-5 bg-blue-700 text-white w-full rounded-lg p-10 pb-2 h-fit z-10 flex flex-col "
                    >
                      ...
                      <div className="py-3 ">
                        {array.map((person, index) => (
                          ...
                          >
                            ...
                            <p className="pr-1 text-lg lg:pr-4 flex w-full pl-2 lg:pl-4">
                              {person.name}
                            </p>
              ...
              <TabsContent value="reactions">
                <div className="flex flex-col  items-center order-3 mt-4 ">
                  ...
                  >
                    <div className="pt-5 bg-blue-700 w-full rounded-lg p-10 pb-2  z-10 ">
                      <div className="flex flex-row border-b-2 justify-center ">
                        <h2 className="font-semibold lg:text-2xl text-sm pb-1 flex  pr-1">
                          Messages with
                        </h2>
                        <Select onValueChange={(v: any) => handleChange(v)}>
                          <SelectTrigger className="w-[60px]  h-[22px] text-black font-semibold">
                        ...
                        <p className="font-semibold lg:text-xl text-sm pb-1 flex justify-center pl-1">
                          + Reactions
                        </p>
                      </div>
              ...
              <TabsContent value="most">
                <div
                  id="photo"
                  className="border-t-2 border-slate-600 mt-4 flex items-center flex-col"
                >
                  <div className="flex justify-center py-4">
                    <h2 className="text-xl text-white font-semibold font-Switzer tracking-wider bg-blue-700 rounded-sm p-2  w-fit border-2 border-white justify-center flex">
                      Images
                    </h2>
                  </div>
                  <Carousel
                      ...
                      <CarouselItem>
                        <div className="pb-1 text-white">
                          ...
                          <div className="flex-row flex justify-between">
                            <p className="text-sm">
                              Sent by{" "}
                              <strong className="text-base">John Pork</strong>
                            </p>
                ...
                <div
                  id="video"
                  className="border-t-2 border-slate-600 my-4 flex flex-col items-center"
                >
                  <div className="flex justify-center py-4">
                    <h2 className="text-xl text-white font-semibold font-Switzer tracking-wider bg-blue-700 rounded-sm p-2  w-fit border-2 border-white justify-center flex">
                      Videos
                ...
                <div
                  id="audio"
                  className="border-t-2 border-slate-600  flex flex-col items-center"
                >
                  <div className="flex justify-center py-4">
                    <h2 className="text-xl text-white font-semibold font-Switzer tracking-wider bg-blue-700 rounded-sm p-2  w-fit border-2 border-white justify-center flex">
                      Audio
