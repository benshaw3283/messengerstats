            ...
            <div id="photo" className="border-t-2 border-slate-600 mt-4">
              ...
              >
                <CarouselContent className="-ml-1">
                  ...
                  <CarouselItem>
                    <div className="pb-1">
                      <p className="font-semibold">2nd most reacted image</p>
                      <div className="flex-row flex justify-between">
                        <p>Sent by John Pork</p>
                        <div className="w-16 h-6 bg-white rounded-full flex ">
                  ...
                  <CarouselItem>
                    <div className="pb-1">
                      <p className="font-semibold">3rd most reacted image</p>
                      <div className="flex-row flex justify-between">
                        <p>Sent by John Pork</p>
                        <div className="w-16 h-6 bg-white rounded-full flex ">
            ...
            <div id="video" className="border-t-2 border-slate-600 mt-4">
              ...
              >
                <CarouselContent className="-ml-1 ">
                  ...
                  <CarouselItem>
                    <div className="pb-1">
                      <p className="font-semibold">2nd most reacted video</p>
                      <div className="flex-row flex justify-between">
                        <p>Sent by John Pork</p>
                        <div className="w-16 h-6 bg-white rounded-full flex ">
                          <p className="text-blue-700 pl-1 font-semibold">{`3 ${laughEmoji}${thumbEmoji}`}</p>
